...
type GetterFn = (arg1: string | number | Array<string>, arg2: GameObject) => string | number;
...
export class ComparatorConditionController implements ConditionController {
  ...
  private getValue(
    ...
    return this.getters[arg.type](arg.value, gameObject);
  }
  ...
  check(props: ComparatorConditionProps, gameObject: GameObject): boolean {
    ...
    const arg1 = this.getValue(props.arg1, gameObject);
    const arg2 = this.getValue(props.arg2, gameObject);
